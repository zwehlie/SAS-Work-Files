...
*Question 10: Use proc export to export the Iris dataset to Microsoft
Excel. Open the Excel file to verify it was created;
proc export
data=Class.iris
outfile="C:\Users\zwehl\OneDrive - Kennesaw State University\In- class activity Week 3.xls"
dbms=xls
replace;
sheet = "iris";
run;

*Question 11: Use proc export to export the Iris dataset to a CSV file;
proc export
data=Class.iris
outfile="C:\Users\zwehl\OneDrive - Kennesaw State University\In- class activity Week 3.csv"
dbms=csv
replace;
run;
